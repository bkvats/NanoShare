export default function Header() {
    return (
        <header className="sticky top-0 z-50 bg-black shadow-white border-white border-opacity-20 border-b-[0.009px] w-full flex items-center py-2 justify-between px-16">
