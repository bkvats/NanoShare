...
export default function Home() {
    ...
    return (
        <>
            <div className="relative h-[560px] flex flex-col items-center mt-12">
                <div className="absolute w-[70%] z-10 top-24 flex flex-col items-center gap-4">
                ...
                <div className="absolute top-0 pointer-events-none border-light animate-pulse" >
                    <img src="src/pages/images/rainbow.png" alt="rainbow-design" />
                </div>
                <img src="src/pages/images/connect.png" alt="" className="absolute -bottom-20 z-10" width={500} />
            </div>
            <div className="text-3xl font-medium flex gap-2 items-center justify-center w-full mt-32 py-10 border-light ">Share your <span className="flex items-center gap-2 text-white-light font-light border-light py-2 px-4 rounded-full text-lg"><SiFiles /> Files</span> without compromising <span className="flex items-center gap-2 text-md text-white-light font-light border-light py-2 px-4 rounded-full text-lg"><MdOutlineSecurity /> Security</span></div>
            <div className="grid grid-cols-2 grid-rows-2">
                {
                    stepsCard.map((i) => (
                        <div className="border-light p-8 pb-0">
